...
<!-- release-link:start -->
Read the [current release guide](docs/releases/4.44.1.md) for LocalSetup 4.44.1, including compatibility, updating, and verification. Find downloads in the [latest published release](https://github.com/CruxExperts/localsetup/releases/latest).
<!-- release-link:end -->
