...
Release, source, and installed SBOM component versions now identify the LocalSetup framework version; artifact metadata retains its separate pack-format version. Installation layout and public command names do not change.
